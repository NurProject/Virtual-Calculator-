...
def button_equal():
    ...
    if math_operation == "addition":
        display_entry.insert(tk.END, f_num + float(second_number))
...
window = tk.Tk()
window.title("Virtual Calculator")

# Create the entry field
display_entry = tk.Entry(window, width=30, borderwidth=5)
...
button_equal = tk.Button(window, text="=", padx=48, pady=10, command=button_equal)
button_clear = tk.Button(window, text="Clear", padx=37, pady=10, command=button_clear)
